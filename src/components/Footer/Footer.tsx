      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-4">
            <Link className="text-black" href="https://github.com/itering/subscan-essentials-ui-react" target="_blank" rel="noopener noreferrer">
            ...
            <Link className="text-black" href="mailto:hello@itering.io" target="_blank" rel="noopener noreferrer">
              <div className="transition-colors">
