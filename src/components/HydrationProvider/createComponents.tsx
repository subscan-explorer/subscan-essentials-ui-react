...
export type HydrationComponentFunction = (props: React.PropsWithChildren) => JSX.Element | null
...
export default function createComponents(useHydrated: Function): HydrationComponents {
